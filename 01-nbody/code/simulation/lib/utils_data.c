...
void data_writeCalc(double angmoment, double energy, double semi, FILE* pdstfile2,
                    float timeCurrent)
{
  char dataLine[params.MAX_LINE_LENGTH];
  snprintf(dataLine, params.MAX_LINE_LENGTH, "%.4lf,%.8lf,%.8lf,%.8lf\n",
           timeCurrent, angmoment, energy, semi);
